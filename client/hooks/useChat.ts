 ...
 */
export function useSchools(divisionId: string | null) {
  return useQuery({
    queryKey: ['schools', divisionId],
    queryFn: () => schoolsApi.getSchoolsByDivision(divisionId!),
    enabled: !!divisionId,
...
/**
 * Hook to list schools with optional filters
 */
