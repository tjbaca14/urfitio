...
class ChatOrchestrator:
    ...
    async def process_chat(self, chat_request: ChatRequest) -> Message:
        ...
        Args:
            chat_request: Chat request with messages and optional context query (school name)
        ...
        # Delegate to generic RAG pipeline with school name
...
def create_chat_orchestrator(
    cache: Dict[str, str], llm_provider: BaseLLMProvider
) -> ChatOrchestrator:
    """
